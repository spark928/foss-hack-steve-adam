...
class ChapterNotesTab extends StatefulWidget {
  final String chapterId;

  const ChapterNotesTab({super.key, required this.chapterId});

  @override
  State<ChapterNotesTab> createState() => _ChapterNotesTabState();
}

class _ChapterNotesTabState extends State<ChapterNotesTab> {
    ...
    return Scaffold(
      body: Consumer<NoteProvider>(
        builder: (context, noteProvider, child) {
          final notes = noteProvider.getNotesForChapter(widget.chapterId);
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'add_chapter_written_note',
    ...
    return Scaffold(
      body: Consumer<ENoteProvider>(
        builder: (context, enoteProvider, child) {
          final enotes = enoteProvider.getENotes(chapterId: widget.chapterId);
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'add_chapter_file_note',
        onPressed: () {
          final chapters = Provider.of<ChapterProvider>(context, listen: false).chapters;
          final chapter = chapters.firstWhere((c) => c.id == widget.chapterId);
          Provider.of<ENoteProvider>(context, listen: false).importFile(
