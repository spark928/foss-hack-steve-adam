...
class SubjectPerformanceTab extends StatefulWidget {
  final String subjectId;
  const SubjectPerformanceTab({super.key, required this.subjectId});

  @override
  State<SubjectPerformanceTab> createState() => _SubjectPerformanceTabState();
}

class _SubjectPerformanceTabState extends State<SubjectPerformanceTab> {
  ...
  Widget build(BuildContext context) {
    return Consumer<StudyProvider>(
      builder: (context, studyProvider, child) {
        final chartData = studyProvider.getChartData(_selectedRange, subjectId: widget.subjectId);
        ...
        return ListView(
          ...
          children: [
            Row(
              ...
              children: [
                 Text('Subject Analytics', style: Theme.of(context).textTheme.headlineMedium),
